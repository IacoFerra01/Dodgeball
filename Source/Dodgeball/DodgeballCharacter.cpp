...
ADodgeballCharacter::ADodgeballCharacter()
{
	...
	//Health component 
	HealthComponento = CreateDefaultSubobject<UHealthComponento>(TEXT("Health Componento"));
}
...
void ADodgeballCharacter::OnTakeDamage_Implementation()
{
	...
	if (PlayerController != nullptr)
	{
		PlayerController->UpdateHealthPercent(HealthComponento->GetHealthPercent());
	}
}
